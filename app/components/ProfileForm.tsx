...
export function ProfileForm({
    ...
    return (
        ...
        >
            <label htmlFor="pseudo" className="text-sm text-gray-300">Pseudo (3-25 caractères)</label>
            <input
                id="pseudo"
                type="text"
                value={pseudo}
            ...
            <label htmlFor="image" className="text-sm text-gray-300 mt-2">Avatar URL (optionnel)</label>
            <input
                id="image"
                type="text"
                value={image}
